...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'roamdiana4@gmail.com';  // Your email address
        $mail->Password = 'kefx sepu dooi erke';  // App-specific password or email password
        ...
        $mail->addAddress('aninda2010@gmail.com');  // Set the recipient email
